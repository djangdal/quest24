...
def read():
    ...
    if status == MIFAREReader.MI_OK:
        ...
        if status == MIFAREReader.MI_OK:
            ...
            # MIFAREReader.MFRC522_Read(17)
            # MIFAREReader.MFRC522_Write(17, [4] + [0]*15)
            v = MIFAREReader.MFRC522_Read(17)
            if v is not None:
                print("Our print", v)
                if len(v) < 1:
                    return (uid, None)
...
def write(val):
    # Create an object of the class MFRC522
    print("Trying to wtire from python")
    MIFAREReader = MFRC522() 
    ...
    if status == MIFAREReader.MI_OK:
        ...
        if status == MIFAREReader.MI_OK:
            print("Card read UID: ", (uid))
            # MIFAREReader.MFRC522_Read(17)
            print("Lets write here")
            MIFAREReader.MFRC522_Write(17, [val] + [0]*15)
